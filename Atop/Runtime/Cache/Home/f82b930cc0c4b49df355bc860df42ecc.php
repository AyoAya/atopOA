...
<!-- 网站标题 -->
	...
	<link rel="stylesheet" href="/Public/Home/css/notice.css">
<!-- 引入css文件 -->
	...
	<div class="message-container">
		<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
			<div class="panel panel-default">
				<div class="panel-heading" role="tab" id="newMessage">
					<h4 class="panel-title">
						<a href="#newMessageCollapse" data-toggle="collapse" data-parent="#accordion" aria-expanded="true" aria-controls="collapseNewMessage">
							未查阅
						</a>
					</h4>
				</div>
				<div id="newMessageCollapse" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="newMessage">
					<div class="panel-body">
						<ul class="noticeList">
							<?php if(is_array($newMessage)): $i = 0; $__LIST__ = $newMessage;if( count($__LIST__)==0 ) : echo "$empty" ;else: foreach($__LIST__ as $key=>$value): $mod = ($i % 2 );++$i;?><li><i class="icon-angle-right"></i>&nbsp;&nbsp;<a href="http://<?php echo ($_SERVER["HTTP_HOST"]); echo ($value["link"]); ?>"><?php echo ($value["message"]); ?></a><small class="pull-right"><?php echo ($value["time"]); ?>发布</small></li><?php endforeach; endif; else: echo "$empty" ;endif; ?>
						</ul>
					</div>
				</div>
			</div>
			<div class="panel panel-default">
				<div class="panel-heading" role="tab" id="historyMessage">
					<h4 class="panel-title">
						<a href="#historyMessageCollapse" data-toggle="collapse" data-parent="#accordion" aria-expanded="true" aria-controls="collapseNewMessage">
							已查阅
						</a>
					</h4>
				</div>
				<div id="historyMessageCollapse" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="historyMessage">
					<div class="panel-body">
						<ul class="noticeList noticeListTextColor">
							<?php if(is_array($oldMessage)): $i = 0; $__LIST__ = $oldMessage;if( count($__LIST__)==0 ) : echo "$empty" ;else: foreach($__LIST__ as $key=>$value): $mod = ($i % 2 );++$i;?><li><i class="icon-angle-right"></i>&nbsp;&nbsp;<a href="http://<?php echo ($_SERVER["HTTP_HOST"]); echo ($value["link"]); ?>"><?php echo ($value["message"]); ?></a><small class="pull-right"><?php echo ($value["view"]); ?>查阅</small></li><?php endforeach; endif; else: echo "$empty" ;endif; ?>
						</ul>
					</div>
				</div>
			</div>
