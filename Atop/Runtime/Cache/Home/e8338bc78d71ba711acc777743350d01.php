...
<body>
	...
	<div class="customerContainer">
		...
		<div class="pull-right" style="position: relative;">
			<form class="layui-form">
				<div class="layui-inline" style="width: 300px;">
					...
					<button style="position: absolute;right:0;top: 0;width: 38px;height: 38px;border: none;background: none;line-height: 42px;" id="submitSearch" lay-submit><i class="layui-icon">&#xe615;</i></button>
				</div>
			</form>
		</div>
		<div class="sr-only">
		...
		<div class="btn-group pull-left btn-group-edit" role="group">
			...
			<a href="/RMA" class="layui-btn layui-btn-primary">
				<span class="icon-comments-alt"></span> 新版客诉
			</a>
			<?php if(($face["department"]) == "4"): ?><a href="/addCustomer" class="layui-btn layui-btn-primary">
			...
			<tbody>
				<?php if(is_array($customer)): $i = 0; $__LIST__ = $customer;if( count($__LIST__)==0 ) : echo "$empty" ;else: foreach($__LIST__ as $key=>$value): $mod = ($i % 2 );++$i;?><tr>
						<td class="customer-left">
							<a href="/Customer?salesperson=<?php echo ($value["salesperson"]); ?>"><img src="<?php echo ($value["face"]); ?>" alt="..." width="60"></a>
						</td>
						<td class="customer-right">
							<a href="/customerDetails/<?php echo ($value["id"]); ?>" class="customer-content">
								<p>
