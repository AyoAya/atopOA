...
<!-- 网站标题 -->
    ...
    <link rel="stylesheet" href="/Public/Home/css/customer-charts.css">
<!-- 引入css文件 -->
    ...
    <script src="/Public/Home/js/vintage.js"></script>
<!-- 引入js文件 -->
    ...
    <script>
        ...
        var _state_options = {
            ...
            series: [{
                ...
                data: [{
                    value: "<?php echo ($status["n"]); ?>",
                    name: "处理失败"
                }, {
                    value: "<?php echo ($status["d"]); ?>",
                    name: "正在处理"
                }, {
                    value: "<?php echo ($status["y"]); ?>",
                    name: "已经处理"
                }],
                itemStyle: {
                    emphasis: {
