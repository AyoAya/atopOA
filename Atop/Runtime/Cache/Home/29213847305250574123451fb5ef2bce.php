...
<body>
	...
	<div class="pull-left">
		<a href="/Acronym/add" class="layui-btn layui-btn-primary">
			<span class="glyphicon glyphicon-plus"></span> 添加缩略词
		</a>
	</div>
	...
	<ul class="letter">
		<span>分类：</span>
		<?php if(is_array($acronym)): $i = 0; $__LIST__ = $acronym;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$value): $mod = ($i % 2 );++$i;?><li><a href="#<?php echo ($key); ?>"><?php echo ($key); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
	</ul>
	<?php if(is_array($acronym)): $i = 0; $__LIST__ = $acronym;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$value): $mod = ($i % 2 );++$i;?><a name="<?php echo ($key); ?>" class="category"><i class="icon-caret-right"></i><?php echo ($key); ?></a>
		<?php if(is_array($value)): $i = 0; $__LIST__ = $value;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><div class="acronym-box">
				<div class="wrap-heading">
					<a href="/Acronym/details/id/<?php echo ($val["id"]); ?>" class="jc-p"><p><?php echo ($val["acronym"]); ?></p></a>
				</div>
				<!--<div class="wrap-footer">
					<p class="qc-p"><?php echo ($val["full_name"]); ?></p>
					<p class="yy-p"><?php echo ($val["meaning"]); ?></p>
				</div>-->
