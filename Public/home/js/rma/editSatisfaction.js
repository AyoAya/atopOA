/**
 * Created by Fulwin on 2017/7/10.
 */
$(function(){
    ...
    sfUploader.on('fileQueued', function( file ){
        var fileItem = '<div class="file-item" id="'+ file.id +'">' +
            ...
            '</div>';
        $(sfUploaderOption.pick).next().append(fileItem);
    });
    // 上传错误时
    ...
    // 所有文件上传结束时
    sfUploader.on('uploadFinished', function(){
        $.ajax({
